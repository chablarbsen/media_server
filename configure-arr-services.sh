...
echo "   - Access Prowlarr at: http://192.168.1.100:80/prowlarr"
...
echo "   - Access Bazarr at: http://192.168.1.100:80/bazarr"
...
echo "Lidarr:   http://192.168.1.100:80/lidarr"
echo "Readarr:  http://192.168.1.100:80/readarr"
echo "Prowlarr: http://192.168.1.100:80/prowlarr"
echo "Bazarr:   http://192.168.1.100:80/bazarr"
echo "SABnzbd:  http://192.168.1.100:80/sabnzbd"
echo "Deluge:   http://192.168.1.101:8112"
echo ""
