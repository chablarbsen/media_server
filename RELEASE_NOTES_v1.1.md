...
```yaml
# BEFORE (v1.0):
- "YOUR_VPN_IP:8080:8080"  # SABnzbd bound to specific interface
- "YOUR_VPN_IP:8112:8112"  # Deluge bound to specific interface
...
volumes:
  - ./sonarr:/config
  - /data:/data
  - /home/username/ssd-cache/downloads:/downloads  # Redundant
...
**Problem:**
- Personal domain "your-domain.com" exposed in public repository
